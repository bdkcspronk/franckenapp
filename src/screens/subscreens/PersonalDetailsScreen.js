        ...
        {editingAddress ? (
          <>
            ...
            <View style={{ flexDirection: 'row', marginTop: theme.spacing.sm }}>
              <Button color={theme.colors.primary} title="Save" onPress={async () => {
                try {
              ...
              <Button title="Cancel" onPress={() => { setAddress(user.address || ''); setEditingAddress(false); }} />
            </View>
          </>
        ) : (
          <>
            ...
            <TouchableOpacity onPress={() => setEditingAddress(true)} style={{ marginTop: theme.spacing.sm }}>
              <Text style={{ color: theme.colors.primary }}>Edit address</Text>
            </TouchableOpacity>
          </>
        )}
      </View>
