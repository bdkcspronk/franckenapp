...
export default function PrivacyScreen() {
	...
	<ScrollView style={{ flex: 1 }} contentContainerStyle={{ padding: theme.spacing.lg, paddingBottom: theme.spacing.xxl }}>
			...
			<Text style={{ ...theme.typography.h3, marginTop: theme.spacing.md }}>What data we store and why</Text>

			<Text style={{ ...theme.typography.body, marginTop: theme.spacing.sm }}>
				This section describes the personal information of our members that we store. Only the board members and the
				members of the compucie (the committee responsible for maintaining our digital facilities) have direct access
				to this data. Sometimes a committee will request the names and email addresses of participants for an activity;
				in such cases the board decides whether the data may be shared.
			</Text>

			<Text style={{ ...theme.typography.h3, marginTop: theme.spacing.md }}>Personal information</Text>
			...
			<Text style={{ ...theme.typography.h3, marginTop: theme.spacing.md }}>Contact information</Text>
			...
			<Text style={{ ...theme.typography.h3, marginTop: theme.spacing.md }}>Study information</Text>
			...
			<Text style={{ ...theme.typography.h3, marginTop: theme.spacing.md }}>Photos</Text>
			...
			<Text style={{ ...theme.typography.h3, marginTop: theme.spacing.md }}>Circumstantial information</Text>
			...
			<Text style={{ ...theme.typography.h3, marginTop: theme.spacing.md }}>Finances</Text>
			...
			<Text style={{ ...theme.typography.h3, marginTop: theme.spacing.md }}>Sponsorship and advertisements</Text>
			...
			<Text style={{ ...theme.typography.h3, marginTop: theme.spacing.md }}>Third parties & services</Text>
			...
			<Text style={{ ...theme.typography.h3, marginTop: theme.spacing.md }}>Data storage</Text>
			...
			<Text style={{ ...theme.typography.h3, marginTop: theme.spacing.md }}>List of data we store</Text>
