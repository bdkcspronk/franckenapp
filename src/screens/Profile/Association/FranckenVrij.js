...
export default function FranckenVrijScreen() {
	...
	return (
		<View style={{ flex: 1, padding: theme.spacing.xl }}>
			...
			<TouchableOpacity
				style={{ marginTop: theme.spacing.md, paddingVertical: theme.spacing.sm, paddingHorizontal: theme.spacing.md, borderRadius: 8, backgroundColor: theme.colors.activate }}
				onPress={handleOpen}
			>
